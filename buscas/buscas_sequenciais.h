...
/*Esta função busca um livro em um arquivo de forma sequencial. Ela lê registros de livros um por um, comparando
 o código do funcionário com o código fornecido como argumento.*/
TLivro *buscarLivro_sequencialmente(FILE *arquivo, int codigo, FILE *logFile);

/*Esta função salva um registro de log em um arquivo de log. Ela usa fwrite para escrever cada parte do registro.*/
